#
#  Be sure to run `pod spec lint SangforSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "fionaly89" => "liyue271181776@gmail.com" }
  # Or just: spec.author    = "fionaly89"
  # spec.authors            = { "fionaly89" => "liyue271181776@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/fionaly89"
  ...
  spec.ios.vendored_frameworks = 'Classes/IJKMediaFrameworkWithSSL.framework'

  # 公开头文件
  spec.public_header_files = 'Classes/IJKMediaFrameworkWithSSL.framework/Headers/*.h'
